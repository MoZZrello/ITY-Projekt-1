...
\begin{quotation}
Čím více \emph{druhů}, \textbf{řezů}, {\LARGE velikostí}, {\color{blue} barev} písma a jiných {\color{red}\textsc{efektů}} \underline{použijeme}, tím {\color{orange}profesionálněji} bude {\fontfamily{pzc}\selectfont {\Large dokument}} vypadat. {\tiny Čtenář} tím bude vždy \textbf{\Huge{nadšen!}}
\end{quotation}
